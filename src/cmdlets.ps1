...
. (import-script cmdlets\Get-GraphCurrentConnection)
...
. (import-script cmdlets\New-GraphLocalCertificate)
. (import-script cmdlets\Register-GraphApplication)
...
. (import-script cmdlets\Select-GraphProfile)
