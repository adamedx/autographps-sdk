...
# only the properties required for this module to use it and generates synthetic values for
# any such properties that are specific to a tenant:
#
#
#  Get-GraphResource /servicePrincipals -Filter "appId eq '00000003-0000-0000-c000-000000000000'" | Select-Object appRoles, oauth2PermissionScopes | Select-Object @{label='id';expression={(new-guid).guid}}, appRoles, oauth2PermissionScopes | ConvertTo-Json -WarningAction SilentlyContinue
#

$__DefaultScopeData = @'
{
  "id": "5f2c91aa-4cbb-40c3-bb54-05a2570f238f",
  "appRoles": [
    {
    ...
    {
      "allowedMemberTypes": "Application",
      "description": "Allows the app to read all┬áclass assignments without grades for all users without a signed-in user.",
    ...
    {
      "allowedMemberTypes": "Application",
      "description": "Allows the app to create, read, update and delete all┬áclass assignments without grades for all users without a signed-in user.",
      "displayName": "Create, read, update and delete all┬áclass assignments without grades",
    ...
    {
      "allowedMemberTypes": "Application",
      "description": "Allows the app to read all┬áclass assignments with grades for all users without a signed-in user.",
    ...
    {
      "allowedMemberTypes": "Application",
      "description": "Allows the app to create, read, update and delete all┬áclass assignments with grades for all users without a signed-in user.",
      "displayName": "Create, read, update and delete all┬áclass assignments with grades",
    ...
    {
      "allowedMemberTypes": "Application",
      "description": "Allows┬áthe┬áapp┬áto┬áread┬ásubject┬árights requests┬áwithout a┬ásigned-in┬áuser.",
      "displayName": "Read┬áall subject┬árights requests",
    ...
    {
      "allowedMemberTypes": "Application",
      "description": "Allows┬áthe┬áapp┬áto┬áread┬áand┬áwrite subject┬árights requests┬áwithout a signed in user.",
      "displayName": "Read┬áand┬áwrite┬áall subject┬árights requests",
    ...
    {
      "allowedMemberTypes": "Application",
      "description": "Allows the app to read group properties and memberships, and read┬áconversations for all groups, without a signed-in user.",
    ...
    },
    {
      ...
      "displayName": "Read Records Management configuration,┬álabels and policies",
    ...
    {
      "allowedMemberTypes": "Application",
      "description": "Allows the app to read┬átags in Teams┬áwithout a signed-in user.",
    ...
    {
      "allowedMemberTypes": "Application",
      "description": "Allow the application to access a subset of site collections without a signed in user.┬á┬áThe specific site collections and the permissions granted will be configured in SharePoint Online.",
    ...
    {
      "allowedMemberTypes": "Application",
      "description": "Allows the app to read and write the organization and related resources, without a signed-in user.┬áRelated resources include things like subscribed skus and tenant branding information.",
    ...
    {
      "allowedMemberTypes": "Application",
      "description": "Allows the app to read the organization and related resources, without a signed-in user.┬áRelated resources include things like subscribed skus and tenant branding information.",
    ...
    {
      "allowedMemberTypes": "Application",
      "description": "Allows the app to read and write your organizationΓÇÖs identity (authentication) providersΓÇÖ properties without a signed in user.",
    ...
    {
      "allowedMemberTypes": "Application",
      "description": "Allows the app to read your organizationΓÇÖs identity (authentication) providersΓÇÖ properties without a signed in user.",
    ...
    {
      "allowedMemberTypes": "Application",
      "description": "Allows the app to create threat indicators, and fully manage those threat indicators (read, update and delete), without a signed-in user. ┬áIt cannot update any threat indicators it does not own.",
    ...
    {
      "allowedMemberTypes": "Application",
      "description": "Allows the app to read your organizationΓÇÖs security events without a signed-in user. Also allows the app to update editable properties in security events.",
      "displayName": "Read and update your organizationΓÇÖs security events",
    ...
    {
      "allowedMemberTypes": "Application",
      "description": "Allows the app to read your organizationΓÇÖs security events without a signed-in user.",
      "displayName": "Read your organizationΓÇÖs security events",
    ...
    {
      "allowedMemberTypes": "Application",
      "description": "Allows the app to read and update identity risk detection information for your organization without a signed-in user. Update operations include confirming risk event detections.┬á",
    ...
    {
      "allowedMemberTypes": "Application",
      "description": "Allows the app to read and update identity risky user information for your organization without a signed-in user. ┬áUpdate operations include dismissing risky users.",
    ...
    {
      "allowedMemberTypes": "Application",
      "description": "Allows the app to create other applications, and fully manage those applications (read, update, update application secrets and delete), without a signed-in user. ┬áIt cannot update any apps that it is not an owner of.",
    ...
    {
      "allowedMemberTypes": "Application",
      "description": "Allows the app to read and write all domain properties without a signed in user. ┬áAlso allows the app to add, ┬áverify and remove domains.",
    ...
    {
      "allowedMemberTypes": "Application",
      "description": "Allows the app to anonymously join group calls and scheduled meetings in your organization, without a signed-in user. ┬áThe app will be joined as a guest to meetings in your organization.",
    ...
    {
      "allowedMemberTypes": "Application",
      "description": "Allows the app to join group calls and scheduled meetings in your organization, without a signed-in user. ┬áThe app will be joined with the privileges of a directory user to meetings in your organization.",
    ...
    {
      "allowedMemberTypes": "Application",
      "description": "Allows the app to place outbound calls to a single user and transfer calls to users in your organizationΓÇÖs directory, without a signed-in user.",
    ...
    {
      "allowedMemberTypes": "Application",
      "description": "Allows the app to read and write the properties of devices managed by Microsoft Intune, without a signed-in user. Does not allow high impact operations such as remote wipe and password reset on the deviceΓÇÖs owner",
    ...
    {
      "allowedMemberTypes": "Application",
      "description": "Allows the app to send, read, update and delete userΓÇÖs notifications, without a signed-in user.",
    ...
    {
      "allowedMemberTypes": "Application",
      "description": "Allows the application to read and write authentication methods of all users in your organization, without a signed-in user.                       Authentication methods include things like a userΓÇÖs phone numbers and Authenticator app settings. This                      does not allow the app to see secret information like passwords, or to sign-in or otherwise use the authentication methods",
    ...
    {
      "allowedMemberTypes": "Application",
      "description": " Allows the app to read authentication methods of all users in your organization, without a signed-in user.                       Authentication methods include things like a userΓÇÖs phone numbers and Authenticator app settings. This does not allow the                      app to see secret information like passwords, or to sign-in or otherwise use the authentication methods.",
    ...
    {
      "allowedMemberTypes": "Application",
      "description": "Allows the app to read and write all authentication method policies for the tenant, without a signed-in user.┬á",
      "displayName": "Read and write all authentication method policies┬á",
    ...
    {
      "allowedMemberTypes": "Application",
      "description": "Allows the application to read printers without a signed-in user.┬á",
    ...
    {
      "allowedMemberTypes": "Application",
      "description": "Allows the application to read the metadata and document content of print jobs without a signed-in user.┬á",
    ...
    {
      "allowedMemberTypes": "Application",
      "description": "Allows the application to read the metadata of print jobs without a signed-in user.┬áDoes not allow access to print job document content.",
    ...
    {
      "allowedMemberTypes": "Application",
      "description": "Allows the application to read and update the metadata of print jobs without a signed-in user.┬áDoes not allow access to print job document content.",
    ...
    {
      "allowedMemberTypes": "Application",
      "description": "Allows the application to read and update print task definitions without a signed-in user.┬á",
    ...
    {
      "allowedMemberTypes": "Application",
      "description": "Allows the app to create teams without a signed-in user.┬á",
    ...
    {
      "allowedMemberTypes": "Application",
      "description": "Allows the app to create chats without a signed-in user.┬á",
    ...
    {
      "allowedMemberTypes": "Application",
      "description": "Allows the app to read all usersΓÇÖ tasks and task lists in your organization, without a signed-in user.",
      "displayName": "Read all usersΓÇÖ tasks and tasklist",
    ...
    {
      "allowedMemberTypes": "Application",
      "description": "Allows the application to list and query any shared user profile information associated with the current tenant without a signed-in user.┬á It also permits the application to export and remove external user data (e.g. customer content or system-generated logs), for any user associated with the current tenant without a signed-in user.",
    ...
    {
      "allowedMemberTypes": "Application",
      "description": "Allows the application to read virtual appointments for all users, without a signed-in user. The app must also be authorized to access an individual userΓÇÖs data by the online meetings application access policy.",
    ...
    {
      "allowedMemberTypes": "Application",
      "description": "Allows the application to list and query any shared user profile information associated with the current tenant without a signed-in user.┬á It also permits the application to export external user data (e.g. customer content or system-generated logs), for any user associated with the current tenant without a signed-in user.",
    ...
    {
      "allowedMemberTypes": "Application",
      "description": "Allows┬áthe┬áapp┬áto┬ámanage all learning┬ácontent┬áin┬áthe┬áorganization's┬ádirectory, without a signed-in user.",
      "displayName": "Manage all┬álearning┬ácontent",
    ...
    {
      "allowedMemberTypes": "Application",
      "description": "Allows the app to create, read, update and delete all usersΓÇÖ tasks and task lists in your organization, without a signed-in user",
      "displayName": "Read and write all usersΓÇÖ tasks and tasklists",
    ...
    {
      "allowedMemberTypes": "Application",
      "description": "Allows the application to read and write virtual appointments for all users, without a signed-in user. The app must also be authorized to access an individual userΓÇÖs data by the online meetings application access policy.",
  ...
  "oauth2PermissionScopes": [
    ...
    },
    {
      ...
      "adminConsentDisplayName": "Read Records Management configuration,┬álabels, and policies",
      ...
      "userConsentDisplayName": "Read Records Management configuration,┬álabels, and policies",
      "value": "RecordsManagement.Read.All"
    },
    {
    ...
    {
      "adminConsentDescription": "Allows the app to read the Cloud PC role-based access control (RBAC) settings, on behalf of the signed-in user.┬á This includes reading Cloud PC role definitions and role assignments.",
      "adminConsentDisplayName": "Read Cloud PC RBAC settings",
      "id": "9619b88a-8a25-48a7-9571-d23be0337a79",
      "isEnabled": true,
      "type": "Admin",
      "userConsentDescription": "Allows the app to read the Cloud PC role-based access control (RBAC) settings, on your behalf.┬á This includes reading Cloud PC role definitions and role assignments.",
    ...
    {
      "adminConsentDescription": "Allows the app to read and write the organization and related resources, on behalf of the signed-in user.┬áRelated resources include things like subscribed skus and tenant branding information.",
      "adminConsentDisplayName": "Read and write organization information",
      "id": "46ca0847-7e6b-426e-9775-ea810a948356",
      "isEnabled": true,
      "type": "Admin",
      "userConsentDescription": "Allows the app to read and write the organization and related resources, on your behalf.┬áRelated resources include things like subscribed skus and tenant branding information.",
      "userConsentDisplayName": "Read and write organization information",
      "value": "Organization.ReadWrite.All"
    },
    {
      "adminConsentDescription": "Allows the app to read the organization and related resources, on behalf of the signed-in user.┬áRelated resources include things like subscribed skus and tenant branding information.",
      "adminConsentDisplayName": "Read organization information",
      "id": "4908d5b9-3fb2-4b1e-9336-1888b7937185",
      "isEnabled": true,
      "type": "Admin",
      "userConsentDescription": "Allows the app to read the organization and related resources, on your behalf.┬áRelated resources include things like subscribed skus and tenant branding information.",
    ...
    {
      "adminConsentDescription": "Allows the app to create threat indicators, and fully manage those threat indicators (read, update and delete), on behalf of the signed-in user. ┬áIt cannot update any threat indicators it does not own.",
      "adminConsentDisplayName": "Manage threat indicators this app creates or owns",
      "id": "91e7d36d-022a-490f-a748-f8e011357b42",
      "isEnabled": true,
      "type": "Admin",
      "userConsentDescription": "Allows the app to create threat indicators, and fully manage those threat indicators (read, update and delete), on your behalf. ┬áIt cannot update any threat indicators that it is not an owner of.",
    ...
    {
      "adminConsentDescription": "Allows the app to read and update identity risk event information for all users in your organization on behalf of the signed-in user.┬áUpdate operations include confirming risk event detections.┬á",
      "adminConsentDisplayName": "Read and write risk event information",
      "id": "9e4862a5-b68f-479e-848a-4e07e25c9916",
      "isEnabled": true,
      "type": "Admin",
      "userConsentDescription": "Allows the app to read and update identity risk event information for all users in your organization on your behalf.┬áUpdate operations include confirming risk event detections.┬á",
      "userConsentDisplayName": "Read and write risk event information",
      "value": "IdentityRiskEvent.ReadWrite.All"
    },
    {
      "adminConsentDescription": "Allows the app to read and update identity risky user information for all users in your organization on behalf of the signed-in user.┬áUpdate operations include dismissing risky users.",
      "adminConsentDisplayName": "Read and write risky user information",
      "id": "e0a7cdbb-08b0-4697-8264-0069786e9674",
      "isEnabled": true,
      "type": "Admin",
      "userConsentDescription": "Allows the app to read and update identity risky user information for all users in your organization on your behalf.┬áUpdate operations include dismissing risky users.",
    ...
    {
      "adminConsentDescription": "Allows the app to read and write the properties of devices managed by Microsoft Intune. Does not allow high impact operations such as remote wipe and password reset on the deviceΓÇÖs owner.",
      "adminConsentDisplayName": "Read and write Microsoft Intune devices",
      "id": "44642bfe-8385-4adc-8fc6-fe3cb2c375c3",
      "isEnabled": true,
      "type": "Admin",
      "userConsentDescription": "Allows the app to read and write the properties of devices managed by Microsoft Intune. Does not allow high impact operations such as remote wipe and password reset on the deviceΓÇÖs owner.",
    ...
    {
      "adminConsentDescription": "Allows the app to read your organizationΓÇÖs security events on behalf of the signed-in user.",
      "adminConsentDisplayName": "Read your organizationΓÇÖs security events",
      "id": "64733abd-851e-478a-bffb-e47a14b18235",
      "isEnabled": true,
      "type": "Admin",
      "userConsentDescription": "Allows the app to read your organizationΓÇÖs security events on your behalf.",
      "userConsentDisplayName": "Read your organizationΓÇÖs security events",
      "value": "SecurityEvents.Read.All"
    },
    {
      "adminConsentDescription": "Allows the app to read your organizationΓÇÖs security events on behalf of the signed-in user. Also allows the app to update editable properties in security events on behalf of the signed-in user.",
      "adminConsentDisplayName": "Read and update your organizationΓÇÖs security events",
      "id": "6aedf524-7e1c-45a7-bd76-ded8cab8d0fc",
      "isEnabled": true,
      "type": "Admin",
      "userConsentDescription": "Allows the app to read your organizationΓÇÖs security events on your behalf. Also allows you to update editable properties in security events.",
      "userConsentDisplayName": "Read and update your organizationΓÇÖs security events",
      "value": "SecurityEvents.ReadWrite.All"
    },
    {
      ...
      "isEnabled": true,
      "type": "Admin",
      "userConsentDescription": "Allows the app to read a list of people in the order that is most relevant to you. Allows the app to read a list of people in the order that is most relevant to another user in your organization. These can include local contacts, contacts from social networking, people listed in your organizationΓÇÖs directory, and people from recent communications.",
      "userConsentDisplayName": "Read all usersΓÇÖ relevant people lists",
      "value": "People.Read.All"
    },
    {
    ...
    },
    {
      ...
      "isEnabled": true,
      "type": "Admin",
      "userConsentDescription": "Allows the app to view and modify your assignments on your behalf including ┬ágrades.",
    ...
    {
      "adminConsentDescription": "Allows the app to read a limited subset of the properties from the structure of schools and classes in an organization's roster and a limited subset of properties about users to be read on behalf of the user.┬áIncludes name, status, education role, email address and photo.",
      "adminConsentDisplayName": "Read a limited subset of users' view of the roster",
      "id": "5d186531-d1bf-4f07-8cea-7c42119e1bd9",
      "isEnabled": true,
      "type": "Admin",
      "userConsentDescription": "Allows the app to view minimal ┬áinformation about both schools and classes in your organization and education-related information about you and other users on your behalf.",
    ...
    },
    {
      ...
      "isEnabled": true,
      "type": "User",
      "userConsentDescription": "Allows the app to read events in all calendars that you can access, including delegate and shared calendars.┬á",
      "userConsentDisplayName": "Read calendars┬áyou can access",
    ...
    },
    {
      ...
      "userConsentDisplayName": "Read and write mail┬áyou can access",
    ...
    {
      "adminConsentDescription": "Allows the app to read and write your organizationΓÇÖs identity (authentication) providersΓÇÖ properties on behalf of the user.",
      "adminConsentDisplayName": "Read and write identity providers",
      "id": "f13ce604-1677-429f-90bd-8a10b9f01325",
      "isEnabled": true,
      "type": "Admin",
      "userConsentDescription": "Allows the app to read and write your organizationΓÇÖs identity (authentication) providersΓÇÖ properties on your behalf.",
      "userConsentDisplayName": "Read and write identity providers",
      "value": "IdentityProvider.ReadWrite.All"
    },
    {
      "adminConsentDescription": "Allows the app to read your organizationΓÇÖs identity (authentication) providersΓÇÖ properties on behalf of the user.",
      "adminConsentDisplayName": "Read identity providers",
      "id": "43781733-b5a7-4d1b-98f4-e8edff23e1a9",
      "isEnabled": true,
      "type": "Admin",
      "userConsentDescription": "Allows the app to read your organizationΓÇÖs identity (authentication) providersΓÇÖ properties on your behalf.",
    ...
    {
      "adminConsentDescription": "Allows the app to read all organizational contacts on behalf of the signed-in user. ┬áThese contacts are managed by the organization and are different from a user's personal contacts.",
      "adminConsentDisplayName": "Read organizational contacts",
      "id": "08432d1b-5911-483c-86df-7980af5cdee0",
      "isEnabled": true,
      "type": "Admin",
      "userConsentDescription": "Allows the app to read all organizational contacts on your behalf.┬á These contacts are managed by the organization and are different from your personal contacts.",
    ...
    },
    {
      ...
      "isEnabled": true,
      "type": "Admin",
      "userConsentDescription": "Allows the app to request and manage time-based assignment and just-in-time elevation of user privileges to manage ┬áyour Azure resources (like your subscriptions, resource groups, storage, compute) on your behalf.",
    ...
    {
      "adminConsentDescription": "Allows the app to send, read, update and delete userΓÇÖs notifications.",
    ...
    {
      "adminConsentDescription": " Allows the app to read and write authentication methods of all users in your organization that the signed-in user has access to.                       Authentication methods include things like a userΓÇÖs phone numbers and Authenticator app settings. This                      does not allow the app to see secret information like passwords, or to sign-in or otherwise use the authentication methods.",
      "adminConsentDisplayName": "Read and write all users' authentication methods.",
      "id": "b7887744-6746-4312-813d-72daeaee7e2d",
      "isEnabled": true,
      "type": "Admin",
      "userConsentDescription": "Allows the app to read and write authentication methods of all users you have access to in your organization.                       Authentication methods include things like a userΓÇÖs phone numbers and Authenticator app settings. This does not allow                      the app to see secret information like passwords, or to sign-in or otherwise use the authentication methods.",
    ...
    {
      "adminConsentDescription": "Allows the app to read authentication methods of all users in your organization that the signed-in user has access to. Authentication methods include things like a userΓÇÖs phone numbers and Authenticator app settings. This does not allow the app to see secret information like passwords, or to sign-in or otherwise use the authentication methods.",
      "adminConsentDisplayName": "Read all users' authentication methods",
      "id": "aec28ec7-4d02-4e8c-b864-50163aea77eb",
      "isEnabled": true,
      "type": "Admin",
      "userConsentDescription": "Allows the app to read authentication methods of all users you have access to in your organization. Authentication methods include things like a userΓÇÖs phone numbers and Authenticator app settings. This does not allow the app to see secret information like passwords, or to sign-in or otherwise use the authentication methods.",
    ...
    {
      "adminConsentDescription": "Allows the app to be able to send emails from the userΓÇÖs mailbox using the SMTP AUTH client submission protocol.",
    ...
    {
      "adminConsentDescription": "Allows the app to read and write the authentication method policies, on behalf of the signed-in user.┬á",
    ...
    {
      "adminConsentDescription": "Allows the application to create (register) printers on behalf of the signed-in user.┬á",
      "adminConsentDisplayName": "Register printersΓÇ»┬á",
      "id": "90c30bed-6fd1-4279-bf39-714069619721",
      "isEnabled": true,
      "type": "Admin",
      "userConsentDescription": "Allows the application to create (register) printers on your behalf.┬á",
      "userConsentDisplayName": "Register printersΓÇ»┬á",
      "value": "Printer.Create"
    },
    {
      "adminConsentDescription": "Allows the application to create (register), read, update, and delete (unregister) printers on behalf of the signed-in user.┬á",
      "adminConsentDisplayName": "Register, read, update, and unregister printers",
      "id": "93dae4bd-43a1-4a23-9a1a-92957e1d9121",
      "isEnabled": true,
      "type": "Admin",
      "userConsentDescription": "Allows the application to create (register), read, update, and delete (unregister) printers on your behalf.┬á┬á",
      "userConsentDisplayName": "Register, read, update, and unregister printers",
      "value": "Printer.FullControl.All"
    },
    {
      "adminConsentDescription": "Allows the application to read printers on behalf of the signed-in user.┬á",
      "adminConsentDisplayName": "Read printers",
      "id": "3a736c8a-018e-460a-b60c-863b2683e8bf",
      "isEnabled": true,
      "type": "Admin",
      "userConsentDescription": "Allows the application to read printers on your behalf.┬á",
      "userConsentDisplayName": "Read printers",
      "value": "Printer.Read.All"
    },
    {
      "adminConsentDescription": "Allows the application to read and update printers on behalf of the signed-in user.┬áDoes not allow creating (registering) or deleting (unregistering) printers.",
      "adminConsentDisplayName": "Read and update printers",
      "id": "89f66824-725f-4b8f-928e-e1c5258dc565",
      "isEnabled": true,
      "type": "Admin",
      "userConsentDescription": "Allows the application to read and update printers on your behalf.┬áDoes not allow creating (registering) or deleting (unregistering) printers.",
      "userConsentDisplayName": "Read and update printers",
      "value": "Printer.ReadWrite.All"
    },
    {
      "adminConsentDescription": "Allows the application to read printer shares on behalf of the signed-in user.┬á",
      "adminConsentDisplayName": "Read printer shares",
      "id": "ed11134d-2f3f-440d-a2e1-411efada2502",
      "isEnabled": true,
      "type": "User",
      "userConsentDescription": "Allows the application to read printer shares on your behalf.┬á",
      "userConsentDisplayName": "Read printer shares",
      "value": "PrinterShare.Read.All"
    },
    {
      "adminConsentDescription": "Allows the application to read and update printer shares on behalf of the signed-in user.┬á",
      "adminConsentDisplayName": "Read and write printer shares",
      "id": "06ceea37-85e2-40d7-bec3-91337a46038f",
      "isEnabled": true,
      "type": "Admin",
      "userConsentDescription": "Allows the application to read and update printer shares on your behalf.┬á",
    ...
    {
      "adminConsentDescription": "Allows the application to read the metadata and document content of print jobs on behalf of the signed-in user.┬á",
      "adminConsentDisplayName": "Read print jobs",
      "id": "afdd6933-a0d8-40f7-bd1a-b5d778e8624b",
      "isEnabled": true,
      "type": "Admin",
      "userConsentDescription": "Allows the application to read the metadata and document content of print jobs on your behalf.┬á",
    ...
    {
      "adminConsentDescription": "Allows the application to read the metadata of print jobs on behalf of the signed-in user.┬áDoes not allow access to print job document content.",
      "adminConsentDisplayName": "Read basic information of print jobs",
      "id": "04ce8d60-72ce-4867-85cf-6d82f36922f3",
      "isEnabled": true,
      "type": "Admin",
      "userConsentDescription": "Allows the application to read the metadata of print jobs on your behalf.┬áDoes not allow access to print job document content.",
    ...
    {
      "adminConsentDescription": "Allows the application to read and update the metadata and document content of print jobs on behalf of the signed-in user.┬á",
      "adminConsentDisplayName": "Read and write print jobs",
      "id": "036b9544-e8c5-46ef-900a-0646cc42b271",
      "isEnabled": true,
      "type": "Admin",
      "userConsentDescription": "Allows the application to read and update the metadata and document content of print jobs on your behalf.┬á",
    ...
    {
      "adminConsentDescription": "Allows the application to read and update the metadata of print jobs on behalf of the signed-in user.┬áDoes not allow access to print job document content.",
      "adminConsentDisplayName": "Read and write basic information of print jobs",
      "id": "3a0db2f6-0d2a-4c19-971b-49109b19ad3d",
      "isEnabled": true,
      "type": "Admin",
      "userConsentDescription": "Allows the application to read and update the metadata of print jobs on your behalf.┬áDoes not allow access to print job document content.",
    ...
    },
    {
      ...
      "isEnabled": true,
      "type": "User",
      "userConsentDescription": "Allows the app to create teams on your behalf.┬á",
    ...
    {
      "adminConsentDescription": "Allows the app to read or modify data that the signed-in user has access to.┬áThis includes all sets, groups and terms in the term store.",
    ...
    },
    {
      ...
      "adminConsentDisplayName": "Create, read, update, and delete userΓÇÖs tasks and task lists",
    ...
    {
      "adminConsentDescription": "Allows the app to read the signed-in userΓÇÖs tasks and task lists, including any shared with the user. Doesn't include permission to create, delete, or update anything.",
    ...
    },
    {
      ...
      "isEnabled": true,
      "type": "User",
      "userConsentDescription": "Allows the app to create chats on your behalf.┬á",
    ...
    {
      "adminConsentDescription": "Allows the application to list and query user profile information associated with the current tenant on behalf of the signed-in user.┬á It also permits the application to export and remove external user data (e.g. customer content or system-generated logs), associated with the current tenant on behalf of the signed-in user.",
      ...
      "isEnabled": true,
      "type": "Admin",
      "userConsentDescription": "Allows the application to list and query shared user profile information associated with the current tenant on your behalf.┬á It also permits the application to export and remove your external user data (e.g. customer content or system-generated logs), associated with the current tenant on your behalf.",
    ...
    {
      "adminConsentDescription": "Allows an application to read virtual appointments for the signed-in user. Only an organizer or participant user can read their virtual appointments.ΓÇ»┬á",
      "adminConsentDisplayName": "Read a user's virtual appointments",
      "id": "27470298-d3b8-4b9c-aad4-6334312a3eac",
      "isEnabled": true,
      "type": "Admin",
      "userConsentDescription": "Allows the app to read virtual appointments on your behalf.ΓÇ»ΓÇ»",
      "userConsentDisplayName": "Read your virtual appointmentsΓÇ»",
    ...
    {
      "adminConsentDescription": "Allows the application to list and query any shared user profile information associated with the current tenant on behalf of the signed-in user.┬á It also permits the application to export and remove external user data (e.g. customer content or system-generated logs), for any user associated with the current tenant on behalf of the signed-in user.",
      ...
      "isEnabled": true,
      "type": "Admin",
      "userConsentDescription": "Allows the application to list and query any shared user profile information associated with the current tenant on your behalf.┬á It also permits the application to export and remove external user data (e.g. customer content or system-generated logs), for any user associated with the current tenant on your behalf.",
    ...
    },
    {
      ...
      "isEnabled": true,
      "type": "Admin",
      "userConsentDescription": "Allows the app to read all recordings of online meetings, on your behalf.┬á",
      "userConsentDisplayName": "Read all recordings of online meetings.┬á",
      "value": "OnlineMeetingRecording.Read.All"
    },
    {
    ...
    {
      "adminConsentDescription": "Allows┬áthe┬áapp┬áto┬ámanage learning┬ácontent┬áin┬áthe┬áorganization's┬ádirectory, on behalf of the signed-in user.",
      "adminConsentDisplayName": "Manage┬álearning┬ácontent",
      "id": "53cec1c4-a65f-4981-9dc1-ad75dbf1c077",
      "isEnabled": true,
      "type": "Admin",
      "userConsentDescription": "Allows┬áthe┬áapp┬áto┬ámanage learning┬ácontent┬áin┬áthe┬áorganization's┬ádirectory, on your behalf.",
    ...
    },
    {
      ...
      "adminConsentDisplayName": "Manage┬álearning┬áprovider",
      "id": "40c2eb57-abaf-49f5-9331-e90fd01f7130",
      "isEnabled": true,
      "type": "Admin",
      "userConsentDescription": "Allows┬áthe┬áapp┬áto┬ácreate, update, read, and delete┬ádata┬áfor┬áthe learning┬áprovider┬áin┬áthe organization's┬ádirectory, on your behalf.",
    ...
    {
      "adminConsentDescription": "Allows the application to list and query user profile information associated with the current tenant on behalf of the signed-in user.┬á It also permits the application to export external user data (e.g. customer content or system-generated logs), associated with the current tenant on behalf of the signed-in user.",
      "adminConsentDisplayName": "Read shared cross-tenant user profile and export data",
      "id": "cb1ba48f-d22b-4325-a07f-74135a62ee41",
      "isEnabled": true,
      "type": "Admin",
      "userConsentDescription": "Allows the application to list and query shared user profile information associated with the current tenant on your behalf.┬á It also permits the application to export your external user data (e.g. customer content or system-generated logs), associated with the current tenant on your behalf.",
    ...
    },
    {
      ...
      "isEnabled": true,
      "type": "Admin",
      "userConsentDescription": "Allows┬áthe┬áapp┬áto┬áread┬ádata┬áfor┬áthe learning┬áprovider┬áin┬áthe organization's┬ádirectory, on your behalf.",
    ...
    {
      "adminConsentDescription": "Allows an application to read and write virtual appointments for the signed-in user. Only an organizer or participant user can read and write their virtual appointments.ΓÇ»",
      "adminConsentDisplayName": "Read and write a user's virtual appointmentsΓÇ»┬á",
      "id": "2ccc2926-a528-4b17-b8bb-860eed29d64c",
      "isEnabled": true,
      "type": "Admin",
      "userConsentDescription": "Allows the app to read and write virtual appointments on your behalf.ΓÇ»┬á",
    ...
    {
      "adminConsentDescription": "Allows the application to list and query any shared user profile information associated with the current tenant on behalf of the signed-in user.┬á It also permits the application to export external user data (e.g. customer content or system-generated logs), for any user associated with the current tenant on behalf of the signed-in user.",
      ...
      "isEnabled": true,
      "type": "Admin",
      "userConsentDescription": "Allows the application to list and query any shared user profile information associated with the current tenant on your behalf.┬á It also permits the application to export external user data (e.g. customer content or system-generated logs), for any user associated with the current tenant on your behalf.",
